...
class Searching:
    def __init__(self, root, AlgoNameVar):
        ...
        self.frame1.grid_propagate(bool(0))
        ...
        self.algo_menu.pack_propagate(bool(0))
        ...
        self.frame_btn1.pack_propagate(bool(0))
        ...
        self.search_element.insert(END, '')
        self.search_element.pack_propagate(bool(0))
        ...
        self.frame_btn2.grid_propagate(bool(0))
        ...
        self.frame_algo_info.grid_propagate(bool(0))
        ...
        self.label_avg.pack_propagate(bool(0))
